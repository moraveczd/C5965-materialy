...
\frame{
	...
	\begin{figure}
		...
		\caption*{$^{13}$C NMR s $^1$H decouplerem ethylbenzenu}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{figure}
		...
		\caption*{$^{13}$C NMR bez $^1$H decoupleru ethylbenzenu}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\end{center}
	\begin{figure}
		\includegraphics[width=.5\textwidth]{img/JEOL_NMR-Magnets_Family.jpg}
	\end{figure}
}
