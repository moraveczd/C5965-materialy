...
\frame{
	...
	\vfill
	\begin{figure}
		\includegraphics[width=.85\textwidth]{img/Ethylbenzen-1H.pdf}
		\caption*{Srovnání $^1$H NMR spekter ethylbenzenu na spektrometrech 60, 300 a 500 MHz}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{center}
		...
		30 & 50 & 1300\footnote[frame]{\href{https://www.businesswire.com/news/home/20250407030056/en/Bruker-Announces-First-of-a-kind-1.3-GHz-High-Resolution-NMR-System}{Bruker Announces First-of-a-kind 1.3 GHz High-Resolution NMR System}} & 326 & 70 \\\hline
		\end{tabular}
	\end{center}
}
